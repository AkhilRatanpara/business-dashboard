...
async function main() {
  console.log('--- RESETTING & SEEDING COMPLETE 2023 CATALOG FROM PDF ---');

  // Delete all existing items, audit logs, price histories to ensure clean slate
  ...
  const categoriesData = [
    ...
    // 2. Openwell Impeller
    {
      id: 'openwell_impeller',
      name: 'Openwell Impeller',
      sortOrder: 2,
    },
    // 3. Mono Block Impeller
    {
      id: 'monoblock_impeller',
      name: 'Mono Block Impeller',
      sortOrder: 3,
    },
    // 4. Thrust Bearing Plate, SS Counter, Bearing Set
    {
    ...
    // 7. S.S. 410 Stud, Allan Cap, Hex Nut-Bolt, Washer
    {
      id: 'studs_bolts',
    ...
    // 9. S.S. Key 410, S.S./C.I. Bowl & Impeller
    {
      id: 'key_bowls',
    ...
    // 10. S.S. Submersible Pump Spares
    {
      id: 'pump_parts',
  ...
  const addItem = (
    ...
    itemsToCreate.push({
      categoryId: catId,
      srNo: srNo || null as any,
      name,
      brand,
      itemCode: code || null as any,
      costPrice: cost,
      retailerPrice: 0,
      customerPrice: 0,
      unit,
  ...
  // S.S. Pump Parts (V-6 C.I. page 6, 1-14)
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 2. OPENWELL IMPELLER (Page 7 - 32 items)
  // ─────────────────────────────────────────────────────────────────────────────
  const openwellItems = [
    ...
    { sr: '7', name: 'Openwell Impeller 2 HP 20X158X65X8X7', r: 460.0 },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 3. MONO BLOCK IMPELLER (Page 8 - 42 items)
  // ─────────────────────────────────────────────────────────────────────────────
  const monoItems = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 4. THRUST BEARING, COUNTER & BEARING SET (Page 9)
  // ─────────────────────────────────────────────────────────────────────────────
  ...
  const thrustItems = [
    ...
    { sr: '4.1', name: 'V-7 Mini 65mm Double Plate - Teflon', r: 120.0 },
    { sr: '4.2', name: 'V-7 Mini 65mm Double Plate - Carbon', r: 180.0 },
    { sr: '4.3', name: 'V-7 Mini 65mm Double Plate - Fiber', r: 160.0 },
    { sr: '5.1', name: 'V-9 Openwell 70mm Double Plate - Teflon', r: 130.0 },
    { sr: '5.2', name: 'V-9 Openwell 70mm Double Plate - Super Teflon', r: 180.0 },
    { sr: '5.3', name: 'V-9 Openwell 70mm Double Plate - Carbon', r: 190.0 },
    { sr: '5.4', name: 'V-9 Openwell 70mm Double Plate - Super Carbon', r: 400.0 },
    { sr: '5.5', name: 'V-9 Openwell 70mm Double Plate - Fiber', r: 180.0 },
    { sr: '5.6', name: 'V-9 Openwell 70mm Double Plate - Super Fiber', r: 260.0 },
    { sr: '6.1', name: 'V-9 Openwell 75mm Double Plate - Super Teflon', r: 200.0 },
    { sr: '6.2', name: 'V-9 Openwell 75mm Double Plate - Carbon', r: 220.0 },
    { sr: '6.3', name: 'V-9 Openwell 75mm Double Plate - Fiber', r: 220.0 },
    { sr: '7.1', name: 'V-9 Openwell 80mm Double Plate - Teflon', r: 180.0 },
    { sr: '7.2', name: 'V-9 Openwell 80mm Double Plate - Super Teflon', r: 240.0 },
    { sr: '7.3', name: 'V-9 Openwell 80mm Double Plate - Carbon', r: 320.0 },
    { sr: '7.4', name: 'V-9 Openwell 80mm Double Plate - Super Carbon', r: 500.0 },
    { sr: '7.5', name: 'V-9 Openwell 80mm Double Plate - Fiber', r: 210.0 },
    { sr: '7.6', name: 'V-9 Openwell 80mm Double Plate - Super Fiber', r: 340.0 },
    { sr: '8.1', name: 'V-6 80x20mm Single Plate - Teflon', r: 160.0 },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 5. L.B. BUSH & RUBBER BUSH (Pages 10-11 - 169 L.B. Bush items + Rubber)
  // ─────────────────────────────────────────────────────────────────────────────
  const lbBushData = [
  ...
  rajRubber.forEach((r) => addItem('raj_rubber_bush', r.n, `Raj & Raj Rubber Bush ${r.s}`, r.r, 'Raj'));

  // Tefcot Rubber Bush (6 items)
  const tefcotRubber = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 6. DIFFUSER (BOWL) & IMPELLER (Pages 12-13)
  // ─────────────────────────────────────────────────────────────────────────────
  // V-4 HF (19 items)
  const v4HfData = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 7. STUDS, NUTS, BOLTS & WASHERS (Page 14)
  // ─────────────────────────────────────────────────────────────────────────────
  // 1. S.S. 410 Stud
  const ss410Studs = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 9. S.S. KEY 410, S.S./C.I. BOWL & IMPELLER (Page 16)
  // ─────────────────────────────────────────────────────────────────────────────
  // S.S. Key 410
  const ssKeyData = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 10. S.S. SUBMERSIBLE PUMP PARTS & HARDWARE (Pages 17-19)
  // ─────────────────────────────────────────────────────────────────────────────
  // Drain Plug
  const drainPlugs = [
  ...
  console.log(`Inserting ${itemsToCreate.length} catalog items into database...`);

  // Insert in batches of 50
  for (let i = 0; i < itemsToCreate.length; i += 50) {
    const batch = itemsToCreate.slice(i, i + 50);
    await prisma.item.createMany({
      data: batch,
    });
  }

  console.log(`Successfully seeded ${itemsToCreate.length} items with exact PDF cost rates and reset retailer/customer rates to 0!`);
}
