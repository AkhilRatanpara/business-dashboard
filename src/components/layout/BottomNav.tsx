...
export function BottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 px-2 py-1.5 bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl border-t border-slate-200 dark:border-slate-800 shadow-2xl transition-colors">
